...
func loadAbilityChangelog() {
   for objectJSON in storedData["ability_changelog"]! {
       let realmObject = AbilityChangelog(value: objectJSON)
        ...
        realmObject.changedInVersionGroup = realmDB.object(ofType: ChangedInVersionGroup.self, forPrimaryKey: objectJSON["changedInVersionGroupId"])
       realmDB.add(realmObject)
   }
}
...
func loadBerries() {
   for objectJSON in storedData["berries"]! {
       let realmObject = Berry(value: objectJSON)
        ...
        realmObject.firmness = realmDB.object(ofType: Firmness.self, forPrimaryKey: objectJSON["firmnessId"])
        realmObject.naturalGiftType = realmDB.object(ofType: NaturalGiftType.self, forPrimaryKey: objectJSON["naturalGiftTypeId"])
       realmDB.add(realmObject)
   }
}
...
func loadBerryFirmness() {
   for objectJSON in storedData["berry_firmness"]! {
       let realmObject = BerryFirmnes(value: objectJSON)
       realmDB.add(realmObject)
   }
}
...
func loadContestCombos() {
   for objectJSON in storedData["contest_combos"]! {
       let realmObject = ContestCombo(value: objectJSON)
        realmObject.firstMove = realmDB.object(ofType: FirstMove.self, forPrimaryKey: objectJSON["firstMoveId"])
        realmObject.secondMove = realmDB.object(ofType: SecondMove.self, forPrimaryKey: objectJSON["secondMoveId"])
       realmDB.add(realmObject)
   }
}
...
func loadEvolutionChains() {
   for objectJSON in storedData["evolution_chains"]! {
       let realmObject = EvolutionChain(value: objectJSON)
        realmObject.babyTriggerItem = realmDB.object(ofType: BabyTriggerItem.self, forPrimaryKey: objectJSON["babyTriggerItemId"])
       realmDB.add(realmObject)
   }
}
...
func loadGenerations() {
   for objectJSON in storedData["generations"]! {
       let realmObject = Generation(value: objectJSON)
        realmObject.mainRegion = realmDB.object(ofType: MainRegion.self, forPrimaryKey: objectJSON["mainRegionId"])
       realmDB.add(realmObject)
   }
}
...
func loadItemCategories() {
   for objectJSON in storedData["item_categories"]! {
       let realmObject = ItemCategory(value: objectJSON)
        realmObject.pocket = realmDB.object(ofType: Pocket.self, forPrimaryKey: objectJSON["pocketId"])
       realmDB.add(realmObject)
   }
}
...
func loadItems() {
   for objectJSON in storedData["items"]! {
       let realmObject = Item(value: objectJSON)
        realmObject.category = realmDB.object(ofType: Category.self, forPrimaryKey: objectJSON["categoryId"])
        realmObject.flingEffect = realmDB.object(ofType: FlingEffect.self, forPrimaryKey: objectJSON["flingEffectId"])
       realmDB.add(realmObject)
   }
}
...
func loadMoveChangelog() {
   for objectJSON in storedData["move_changelog"]! {
       let realmObject = MoveChangelog(value: objectJSON)
        ...
        realmObject.target = realmDB.object(ofType: Target.self, forPrimaryKey: objectJSON["targetId"])
        realmObject.effect = realmDB.object(ofType: Effect.self, forPrimaryKey: objectJSON["effectId"])
       realmDB.add(realmObject)
   }
}
...
func loadMoveDamageClasses() {
   for objectJSON in storedData["move_damage_classes"]! {
       let realmObject = MoveDamageClasse(value: objectJSON)
       realmDB.add(realmObject)
   }
}
...
func loadMoveMeta() {
   for objectJSON in storedData["move_meta"]! {
       let realmObject = MoveMeta(value: objectJSON)
        realmObject.move = realmDB.object(ofType: Move.self, forPrimaryKey: objectJSON["moveId"])
        realmObject.metaCategory = realmDB.object(ofType: MetaCategory.self, forPrimaryKey: objectJSON["metaCategoryId"])
        realmObject.metaAilment = realmDB.object(ofType: MetaAilment.self, forPrimaryKey: objectJSON["metaAilmentId"])
       realmDB.add(realmObject)
   }
}
...
func loadMoves() {
   for objectJSON in storedData["moves"]! {
       let realmObject = Move(value: objectJSON)
        ...
        realmObject.type = realmDB.object(ofType: Type.self, forPrimaryKey: objectJSON["typeId"])
        realmObject.target = realmDB.object(ofType: Target.self, forPrimaryKey: objectJSON["targetId"])
        realmObject.damageClass = realmDB.object(ofType: DamageClass.self, forPrimaryKey: objectJSON["damageClassId"])
        realmObject.effect = realmDB.object(ofType: Effect.self, forPrimaryKey: objectJSON["effectId"])
        realmObject.contestType = realmDB.object(ofType: ContestType.self, forPrimaryKey: objectJSON["contestTypeId"])
        realmObject.contestEffect = realmDB.object(ofType: ContestEffect.self, forPrimaryKey: objectJSON["contestEffectId"])
...
func loadNatures() {
   for objectJSON in storedData["natures"]! {
       let realmObject = Nature(value: objectJSON)
        realmObject.decreasedStat = realmDB.object(ofType: DecreasedStat.self, forPrimaryKey: objectJSON["decreasedStatId"])
        realmObject.increasedStat = realmDB.object(ofType: IncreasedStat.self, forPrimaryKey: objectJSON["increasedStatId"])
        realmObject.hatesFlavor = realmDB.object(ofType: HatesFlavor.self, forPrimaryKey: objectJSON["hatesFlavorId"])
        realmObject.likesFlavor = realmDB.object(ofType: LikesFlavor.self, forPrimaryKey: objectJSON["likesFlavorId"])
       realmDB.add(realmObject)
   }
}
...
func loadPalPark() {
   for objectJSON in storedData["pal_park"]! {
       let realmObject = PalPark(value: objectJSON)
        realmObject.species = realmDB.object(ofType: Species.self, forPrimaryKey: objectJSON["speciesId"])
        realmObject.area = realmDB.object(ofType: Area.self, forPrimaryKey: objectJSON["areaId"])
       realmDB.add(realmObject)
   }
}
...
func loadPokedexes() {
   for objectJSON in storedData["pokedexes"]! {
       let realmObject = Pokedexe(value: objectJSON)
        realmObject.region = realmDB.object(ofType: Region.self, forPrimaryKey: objectJSON["regionId"])
       realmDB.add(realmObject)
   }
}
...
func loadPokemonEvolution() {
   for objectJSON in storedData["pokemon_evolution"]! {
       let realmObject = PokemonEvolution(value: objectJSON)
        realmObject.evolvedSpecies = realmDB.object(ofType: EvolvedSpecies.self, forPrimaryKey: objectJSON["evolvedSpeciesId"])
        realmObject.evolutionTrigger = realmDB.object(ofType: EvolutionTrigger.self, forPrimaryKey: objectJSON["evolutionTriggerId"])
        realmObject.triggerItem = realmDB.object(ofType: TriggerItem.self, forPrimaryKey: objectJSON["triggerItemId"])
        realmObject.gender = realmDB.object(ofType: Gender.self, forPrimaryKey: objectJSON["genderId"])
        realmObject.location = realmDB.object(ofType: Location.self, forPrimaryKey: objectJSON["locationId"])
        realmObject.heldItem = realmDB.object(ofType: HeldItem.self, forPrimaryKey: objectJSON["heldItemId"])
        realmObject.knownMove = realmDB.object(ofType: KnownMove.self, forPrimaryKey: objectJSON["knownMoveId"])
        realmObject.knownMoveType = realmDB.object(ofType: KnownMoveType.self, forPrimaryKey: objectJSON["knownMoveTypeId"])
        realmObject.partySpecies = realmDB.object(ofType: PartySpecies.self, forPrimaryKey: objectJSON["partySpeciesId"])
        realmObject.partyType = realmDB.object(ofType: PartyType.self, forPrimaryKey: objectJSON["partyTypeId"])
        realmObject.tradeSpecies = realmDB.object(ofType: TradeSpecies.self, forPrimaryKey: objectJSON["tradeSpeciesId"])
       realmDB.add(realmObject)
   }
}
...
func loadPokemonForms() {
   for objectJSON in storedData["pokemon_forms"]! {
       let realmObject = PokemonForm(value: objectJSON)
        realmObject.pokemon = realmDB.object(ofType: Pokemon.self, forPrimaryKey: objectJSON["pokemonId"])
        realmObject.introducedInVersionGroup = realmDB.object(ofType: IntroducedInVersionGroup.self, forPrimaryKey: objectJSON["introducedInVersionGroupId"])
       realmDB.add(realmObject)
   }
}
...
func loadPokemonSpecies() {
   for objectJSON in storedData["pokemon_species"]! {
       let realmObject = PokemonSpecy(value: objectJSON)
        realmObject.generation = realmDB.object(ofType: Generation.self, forPrimaryKey: objectJSON["generationId"])
        realmObject.evolvesFromSpecies = realmDB.object(ofType: EvolvesFromSpecies.self, forPrimaryKey: objectJSON["evolvesFromSpeciesId"])
        realmObject.evolutionChain = realmDB.object(ofType: EvolutionChain.self, forPrimaryKey: objectJSON["evolutionChainId"])
        realmObject.color = realmDB.object(ofType: Color.self, forPrimaryKey: objectJSON["colorId"])
        realmObject.shape = realmDB.object(ofType: Shape.self, forPrimaryKey: objectJSON["shapeId"])
        realmObject.habitat = realmDB.object(ofType: Habitat.self, forPrimaryKey: objectJSON["habitatId"])
        realmObject.growthRate = realmDB.object(ofType: GrowthRate.self, forPrimaryKey: objectJSON["growthRateId"])
       realmDB.add(realmObject)
   }
}
...
func loadPokemonSpeciesFlavorText() {
   for objectJSON in storedData["pokemon_species_flavor_text"]! {
       let realmObject = PokemonSpecyFlavorText(value: objectJSON)
        realmObject.species = realmDB.object(ofType: Species.self, forPrimaryKey: objectJSON["speciesId"])
        realmObject.version = realmDB.object(ofType: Version.self, forPrimaryKey: objectJSON["versionId"])
        realmObject.language = realmDB.object(ofType: Language.self, forPrimaryKey: objectJSON["languageId"])
       realmDB.add(realmObject)
...
func loadPokemonSpeciesNames() {
   for objectJSON in storedData["pokemon_species_names"]! {
       let realmObject = PokemonSpecyName(value: objectJSON)
...
func loadPokemonSpeciesProse() {
   for objectJSON in storedData["pokemon_species_prose"]! {
       let realmObject = PokemonSpecyProse(value: objectJSON)
        realmObject.pokemonSpecies = realmDB.object(ofType: PokemonSpecies.self, forPrimaryKey: objectJSON["pokemonSpeciesId"])
       realmDB.add(realmObject)
   }
}
...
func loadPokemonTypesPast() {
   for objectJSON in storedData["pokemon_types_past"]! {
       let realmObject = PokemonTypesPast(value: objectJSON)
        realmObject.pokemon = realmDB.object(ofType: Pokemon.self, forPrimaryKey: objectJSON["pokemonId"])
        realmObject.generation = realmDB.object(ofType: Generation.self, forPrimaryKey: objectJSON["generationId"])
        realmObject.type = realmDB.object(ofType: Type.self, forPrimaryKey: objectJSON["typeId"])
       realmDB.add(realmObject)
...
func loadTypeEfficacy() {
   for objectJSON in storedData["type_efficacy"]! {
       let realmObject = TypeEfficacy(value: objectJSON)
        realmObject.damageType = realmDB.object(ofType: DamageType.self, forPrimaryKey: objectJSON["damageTypeId"])
        realmObject.targetType = realmDB.object(ofType: TargetType.self, forPrimaryKey: objectJSON["targetTypeId"])
       realmDB.add(realmObject)
   }
}
